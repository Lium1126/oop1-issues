...
public class AichiToyotaAddress implements IKadai07_5 {
    ...
    public Map<String, String> searchByCode(String postalCode) {
        ...
        for (String post_code : POSTALCODE_MAP.keySet()) {
            if (post_code.indexOf(postalCode) == 0) {  // 郵便番号が検索する文字列から始まっていたら
                ret.put(post_code, POSTALCODE_MAP.get(post_code));
            }
        }
    ...
    public Map<String, String> searchByAddress(String addressText) {
        ...
        for (String post_code : POSTALCODE_MAP.keySet()) {
            String address = POSTALCODE_MAP.get(post_code);
            if (address.indexOf(addressText) != -1) {  // 検索する市町村名が含まれていたら
                ret.put(post_code, address);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        // 登録されているデータ全件の件数を先に表示　
        System.out.println("登録されているデータは" + POSTALCODE_MAP.size() + "件です");
        System.out.println();

        // searchByCode()メソッドの動作確認
        System.out.println("=====searchByCode()メソッドの動作確認=====");

        result = app.searchByCode("471086");       // 検索ができているか確認
        System.out.print("postalCode=\"471086\":");
        System.out.println("ヒット数 " + result.size() + "件");
        System.out.println(result);

        result = app.searchByCode("4710867");      // 1件しかヒットしないケース
        System.out.print("postalCode=\"4710867\":");
        System.out.println("ヒット数 " + result.size() + "件");
        System.out.println(result);

        result = app.searchByCode("0000000");      // 1件もヒットしないケース
        System.out.print("postalCode=\"0000000\":");
        System.out.println("ヒット数 " + result.size() + "件");
        System.out.println(result);

        result = app.searchByCode("4710867910");   // 検索文字列が郵便番号データより長い文字列
        System.out.print("postalCode=\"4710867910\":");
        System.out.println("ヒット数 " + result.size() + "件");
        System.out.println(result);

        result = app.searchByCode("086");          // 前方一致となっているか確認するケース
        System.out.print("postalCode=\"086\":");
        System.out.println("ヒット数 " + result.size() + "件");
        System.out.println(result);

        result = app.searchByCode("");             // 検索文字列が空文字列のケース(全件ヒット)
        System.out.print("postalCode=\"\":");
        System.out.println("ヒット数 " + result.size() + "件");
        System.out.println(result);
        System.out.println();

        // searchByAddress()メソッドの動作確認
        System.out.println("=====searchByAddress()メソッドの動作確認=====");

        result = app.searchByAddress("桑原");              // 検索ができているか確認
        System.out.print("addressText=\"桑原\":");
        System.out.println("ヒット数 " + result.size() + "件");
        System.out.println(result);

        result = app.searchByAddress("愛知県");            // 全件ヒット
        System.out.print("addressText=\"愛知県\":");
        System.out.println("ヒット数 " + result.size() + "件");
        System.out.println(result);

        result = app.searchByAddress("愛知県豊田市常盤町");  // 1件しかヒットしないケース
        System.out.print("addressText=\"愛知県豊田市常盤町\":");
        System.out.println("ヒット数 " + result.size() + "件");
        System.out.println(result);

        result = app.searchByAddress("静岡県");            // 1件もヒットしないケース
        System.out.print("addressText=\"静岡県\":");
        System.out.println("ヒット数 " + result.size() + "件");
        System.out.println(result);

        result = app.searchByAddress("");                 // 検索文字列が空文字列のケース(全件ヒット)
        System.out.print("addressText=\"\":");
        System.out.println("ヒット数 " + result.size() + "件");
        System.out.println(result);

        result = app.searchByAddress("町");                // 全てではないが、大量にヒットするケース
        System.out.print("addressText=\"町\":");
        System.out.println("ヒット数 " + result.size() + "件");
        System.out.println(result);
        ...
        do {
            // ユーザにメッセージを表示
            System.out.println();
            System.out.println("1:郵便番号から検索 2:地名から検索 その他の整数:終了");
            ...
            try {
                ...
                switch (mode) {
                    ...
                    case 2:
                        System.out.print("地名: ");
                        input = sc.nextLine();
                        result = app.searchByAddress(input);
                        System.out.println("ヒット数 " + result.size() + "件");
                        System.out.println(result);
                        break;
                }
